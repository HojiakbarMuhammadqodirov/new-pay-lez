...
CREATE TABLE IF NOT EXISTS player_states (
  ...
  difficulty    double precision NOT NULL DEFAULT 3.0,
  updated_at    TEXT NOT NULL
);
...
DO $$ BEGIN
  ALTER TABLE data_sharing_consents ADD CONSTRAINT data_sharing_consents_venue_id_fkey
...
DO $$ BEGIN
  ...
  FOREIGN KEY (deal_id) REFERENCES hot_deals (id) ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
