...
const PATHS = {
  ...
  /* The copy control beside a code staff type at the till. Two sheets, the
     front one whole and the one behind drawn only where it shows — two full
     outlines overlapping at 15px close up into a grid rather than a copy. */
