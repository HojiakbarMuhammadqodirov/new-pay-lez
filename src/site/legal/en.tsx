/**
 * The two legal documents in English — the authoritative text.
 *
 * Moved here verbatim from `legal.tsx` when the documents were translated. The
 * wording is still the delivered PDFs' own (`landing/`), and this module is what
 * every translation beside it is measured against: where one of them and this
 * text differ, this text prevails, and `copy.legal.english` tells the reader so
 * in their own language. Edit a clause here and the four translations are out of
 * date until they are edited too.
 */
